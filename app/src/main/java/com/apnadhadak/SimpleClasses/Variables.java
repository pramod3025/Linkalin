...
public class Variables {
    ...
    public static final String app_hided_folder =root+"/.HidedSmilyLive/";
    public static final String app_showing_folder =root+"/SmilyLive/";
   ...
   public static String gif_api_key1="giphy_api_key_here";
    ...
    public static final  String main_domain="https://apnadhadak.com/";
